...
def process_bright_field(
    ...
    - ``dog_highpass``: two-stage Difference-of-Gaussian high-pass with
    ...
    if method == "dog_highpass":
        ...
        sigma1_stage2 = dog_params.get("sigma1_stage2", 0.8)
        sigma2_stage2 = dog_params.get("sigma2_stage2", 2.4)
        thr_k = dog_params.get("k", 1.0)
        min_thr = dog_params.get("min_thr", 5)

        stage1 = dog_highpass_u8(img_bf_gray, sigma1, sigma2)
        bf_for_process = dog_highpass_u8(stage1, sigma1_stage2, sigma2_stage2)
