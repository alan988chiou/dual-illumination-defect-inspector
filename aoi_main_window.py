...
class AOIInspector(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.combo_bf_method.addItems(["Blur + Threshold", "DoG Highpass x2"])
        ...
        method1_layout.addWidget(QLabel("Blur:"))
        ...
        method1_layout.addWidget(QLabel("Threshold:"))
        ...
        method1_layout.addWidget(self.chk_bf_inverse)
